...
Archives that contain the pregenerated indices have been listed in [e-coli-indices.md](e-coli-indices.md).
...
Individual sequence files have been listed in [e-coli-index-inputs.md](e-coli-index-inputs.md).
