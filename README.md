...
3. Download (some of) [the reads used in the experiment](https://github.com/algbio/panvc-founders#reads-used-in-the-experiment-1) and extract. In addition to the separate reads, the workflow requires the same reads unpaired and renamed in one input. This is done automatically as part of the workflow but we have also prepared the files in question.
